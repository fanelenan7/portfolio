$(document).ready(() => {
  ...
  let descriptions = {
    ...
    skills: "<div class='description'><h3>Skills</h3><ul><li>JavaScript</li><li>Mongoose</li><li>Express.js</li><li>AngularJS</li><li>Node.js</li><li>ReactJS</li><li>jQuery</li><li>HTML5</li><li>CSS3</li><li>Ruby</li><li>Ruby on Rails</li></ul></div>",
